              ...
              <div className=" mt-12 flex flex-col sm:flex-row items-center gap-5 sm:items-start">
                <div className=" flex -space-x-4">
                  {[1, 2, 3, 4, 5].map((u, i) => (
                    <div
                      key={i}
                      className=" inline-block h-10 w-10 rounded-full ring-2 ring-slate-100 relative overflow-hidden"
                    >
                      <Image
                        fill
                        src={`/users/user-${u}.png`}
                        alt={`user-${u}`}
        ...
        <MaxWidthWrapper className=" flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className=" mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className=" flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20 ">
              ...
              <div className=" text-lg leading-8">
                <p>
                  &quot;Absolutely love this case! It fits perfectly and has a
                  premium feel. Been using it for three months now, and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the colors are still vibrant
                  </span>
                  , unlike my old case that started peeling within weeks.
                  Definitely worth it!&quot;
                </p>
              </div>
              <div className=" flex gap-4 mt-2">
